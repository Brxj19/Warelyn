...
export function LocationStockReportPage() {
  return <SimpleReportPage title="Location stock" description="Backend location-level stock projection by SKU." load={reportsService.getLocationStock} columns={columns} />;
}
