...
const salesSteps = [{ key: 'DRAFT', label: 'Draft' }, { key: 'CONFIRMED', label: 'Confirmed' }, { key: 'PICKED', label: 'Picked' }, { key: 'PACKED', label: 'Packed' }, { key: 'FULFILLED', label: 'Fulfilled / Closed', matches: ['FULFILLED', 'CLOSED', 'PARTIALLY_FULFILLED'] }];
...
export function SalesOrderDetailPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <WorkflowProgress current={order.status} steps={salesSteps} />
