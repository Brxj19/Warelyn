...
export function ReorderSuggestionsPage() {
  return <SimpleReportPage title="Reorder suggestions" description="Advisory suggestions only. Purchase orders are not created automatically." load={reportsService.getReorderSuggestions} columns={columns} />;
}
